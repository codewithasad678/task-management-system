...
<div class="row mx-0">
    <h2 class="primary-bg text-white py-2 text-center">Create Task</h1>
        ...
        <div class="row justify-content-evenly my-2 bg-white py-1">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group ">
                            ...
                            <input type="date" class="form-control" name="end_date" id="end_date" placeholder="End Date" required value="{{old('end_date')}}">
                            @error('end_date')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <textarea name="note" class="form-control ckeditor" id="note" cols="" rows="3">{{old('note')}}</textarea>
                </div>
            </div>
